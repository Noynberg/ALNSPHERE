        ...
        <div className={styles.gallery_left}>
          <div className="MARKETPLACE_CONTENT">
            ...
            <div className={styles.downloadImage}>
              ...
              <a href={image} download={true} id = 'mergedimagedownloadtag' style={{"display" : "none"}}>
                Download
              </a>
              {/* <img id = "mergedimgsrc" width = "300px" src = "" alt = 'mergedimage'  /> */}
              <button className= {styles.download_btn} onClick={mergeAndDownloadImage}>Download</button>


              <button onClick={() => setIsSidebarOpen(!isSidebarOpen)} className={styles.filters_btn}>
                Filters
              </button>
            </div>
          </div>
        ...
        >
          ...
          <div className={`${styles.galleryAccordions} mb-30px`}>
            ...
            <Accordion
              ...
              type={items.furItem}
              bodyContent={[
                { title: "1", content: { img: fur1, antenna: cyborg_antennas}},
                { title: "2", content: { img: fur2, antenna: diamond_antennas}},
